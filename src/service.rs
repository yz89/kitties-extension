...
use futures::prelude::*;
use kitties_extension_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi, WASM_BINARY};
...
native_executor_instance!(
	pub Executor,
	kitties_extension_runtime::api::dispatch,
	kitties_extension_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			kitties_extension_runtime::opaque::Block, kitties_extension_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, kitties_extension_runtime::RuntimeApi, _, _>(
